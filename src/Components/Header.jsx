...
const Header = () => {
  ...
  return (
    <section style={{ backgroundImage: `url(${Hero_bg})`, backgroundSize: 'cover' }} className='pt-20 px-10 bg-green-300/10'>
                ...
                <div className='sm:grid sm:grid-cols-2 flex flex-col gap-x-5'>
                    ...
                    <div className='col pt-3.5 flex items-center'>
                        <div className='xl:space-y-7 lg:space-y-6 md:space-y-4 sm:space-y-4 space-y-5 w-11/12 sm:tracking-normal tracking-wide'>
                            {/* title */}
                            <h1 className='xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-3xl font-semibold capitalize xl:tracking-wide'>
                                Make healthy life <br />
                                <div className='xl:my-2.5 lg:my-1.5 sm:my-0 md:my-0.5 my-1'>
                                    with <span className='text-green-500 font-bold'>
                                        fresh grocery
                                    </span>
                                </div>
                            ...
                            {/* description */}
                            <p className='lg:text-lg md:text-sm sm:text-xs text-sm'>
                            ...
                            {/* Shop_now Btn */}
                            <button className='bg-[#1b5e20] px-5 py-[10px] rounded-md text-white text-lg tracking-wider'>
                                Shop Now
                            </button>
                        </div>
                    </div>
